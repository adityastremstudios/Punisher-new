...
class LegacyView(discord.ui.View):
    def __init__(self, text="This feature is available in Punisher for free!"):
    ...
    def legacy_embed(self) -> discord.Embed:
        ...
        _e.title = "💎 Welcome to Punisher"
        _e.description = (
            "__**Perks you get with Punisher**__\n\n"
            f"{emote.white_arrow} Access to `Punisher` bot.\n"
        ...
        _e.set_footer(text="Thank you for being part of the Punisher community ❤️")
        return _e
